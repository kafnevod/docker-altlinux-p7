...
Для коммерческих Заказчиков возможно использование всех классов Linux-дистрбутивов поддерживающих технологию контейнеризации docker. Это позволит разворачивать на основе этих дистрибутивов разработанные серверные и кластерные docker-решения. 
